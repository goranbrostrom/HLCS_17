...
about number of male births and deaths. See Table \@ref(tab:putonmoth), where 
some not so interesting columns are removed. 
...
Third, restricting to mothers born 1826--1814 gives Table \@ref(tab:sos2c). In
order to calculate risks of experience *any* infant death for a mother, we 
calcluate proportions from Table \@ref(tab:sos2c), shown in Table \@ref(tab:sos2d). 

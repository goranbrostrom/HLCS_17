...
For the common part, two approaches are implemented. First *Cox regression* is applied for estimating the effect of grandmother's infant deaths on the age at death for mother's children, then the more direct approach of estimating the effect of grandmother's infant deaths on the probability of an infant death for mother is taken by applying *Poisson regression*, where the number of infant deaths of mother is regressed on grandmother's number of infant deaths.

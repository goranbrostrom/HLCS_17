...
local variants in gene defects as well. Most studies of regional differences are however based on a limited number of rather small regions. Different studies studies are hard to compare due to differences in methodology, both in terms of database management and statistical analysis.

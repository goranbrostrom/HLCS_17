...
knitr::opts_chunk$set(echo = FALSE, comment = NA, fig.height = 2.8, cache = FALSE, message = FALSE)
...
plot(fit.str, col = c("black", "blue", "red"), xlab = "Age (months)", axes = FALSE, 
     ylab = "Cumulative hazards", lty = c(1, 2, 4))

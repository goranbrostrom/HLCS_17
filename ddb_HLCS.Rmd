...
knitr::kable(dr.c, row.names = TRUE, digits = 4, caption = "Analysis of deviance: (1) full model, (2) gmDeaths removed, and (3) gmDeaths and gmBirths removed. Cox regression.")
```
...
fit.str <- coxreg(Surv(exit - enter, event) ~ strata(gmDeaths) + gmBirths + mAge + childBirthdate, data = ef)

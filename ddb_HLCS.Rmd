...
The transformation of the data from POPUM to IDS has been quite straight-forward. This does not mean that the available information is without problems. The sources sometimes contain missing data, which can be a problem when it comes to analysis. For this study, the missing data due to death records not being preserved, as mentioned above, is of course problematic. In family reconstitution, children born are often considered alive, if there is no information on them having died, and the family is still present in the studied area. When death records are missing we have no reliable information on their death or survival, which might result in an over-estimation of infant survival. Although the Swedish system of catechetical registers reported the complete population, making it possible to analyse mortality in most age groups, this is unfortunately not the case when it comes to infant mortality. In many parishes, newborn children were not entered into these registers immediately after birth. The time elapsed between actual birth and it being entered in the register varied in time and between parishes. In the case of Skellefteå for the period when death records are missing, a reasonable assumption is that children with only a birth entry and no further information, despite the fact that the rest of the family is still resident in the parish, died quite young. To finally establish this requires however further controls and the use of precise definitions, something that we have refrained from in this article. These problems are however a good illustration of the need to carefully evaluate the sources and what implications possible deficiencies may have on the analysis.

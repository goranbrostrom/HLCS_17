...
knitr::opts_chunk$set(echo = FALSE, comment = NA, fig.height = 2.8, cache = FALSE)
...
For the common part, two approaches are implemented. First *Cox regression* is applied for estimating the effect of the number of grandmother's infant deaths on the age at death for mother's children, then the more direct approach of estimating the effect of the number of grandmother's infant deaths on the number of infant deaths for mother is taken by applying *Poisson regression*.
...
The negative effects of the dependent-data problem in the common approach may be minimized by (1) building family trees (of women), and (2) only study *male* infant mortality.
...
*  **mAge** Mother's age at the birth of a child. Categorized into the intervals "15-24", "25-34", "35-49", "44-49".
...
dependency structures. What would we need is *family trees* (or rather trees of *women*), 
